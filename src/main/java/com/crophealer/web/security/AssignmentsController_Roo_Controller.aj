...
import com.crophealer.web.security.AssignmentsController;
...
privileged aspect AssignmentsController_Roo_Controller {
    ...
    public String AssignmentsController.create(@Valid Assignments assignments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            ...
            return "assignmentses/create";
        }
        uiModel.asMap().clear();
        assignments.persist();
        return "redirect:/assignmentses/" + encodeUrlPathSegment(assignments.getId().toString(), httpServletRequest);
    }
