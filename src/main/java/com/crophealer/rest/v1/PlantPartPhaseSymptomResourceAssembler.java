...
public class PlantPartPhaseSymptomResourceAssembler {
	...
	public PlantPartPhaseSymptomResourceList toResource(List<PlantPartPhaseSymptom> plantPartPhaseSymptoms, Languages language) {
		if (plantPartPhaseSymptoms == null) return null; 
