...
public class CompanyRestController extends GenericController
{
    ...
    public ResponseEntity < String > createCompany( @RequestBody
    CompanyResource cr )
    {
        if ( cr == null )
            throw new BadRequestException( "CompanyResource is missng" );
    ...
    public ResponseEntity < CompanyResource > getCompany( @PathVariable("id")
    Long id )
    {
        if ( id == null )
