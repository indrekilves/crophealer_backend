...
public class FieldRestController extends GenericController {
	...
	public ResponseEntity<MessageResourceList> getMessagesForField(@PathVariable("id") Long id)
	{   	
		if (id == null) throw new BadRequestException("ID is missng");
		...
		if (msgSet.isEmpty()) throw new ResourceNotFoundException("Messages not found for ID: " + id);	
	...
	public ResponseEntity<DiagnosedProblemResourceList> getDiagnosedProblemsForField(@PathVariable("id") Long id)
	{   	
		if (id == null) throw new BadRequestException("ID is missng");
		...
		if (diagProbSet.isEmpty()) throw new ResourceNotFoundException("DiagnosedProblems not found for ID: " + id);	
