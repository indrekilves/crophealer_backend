...
public class PlantPartPhaseProblemRestService extends GenericRestService
{
    ...
    public ResponseEntity < PlantPartPhaseProblemResourceList > getAllPlantPartPhaseProblemByLanguage(
            Languages language )
    {
        ...
        PlantPartPhaseProblemResourceList prl = asm.toResource( PlantPartPhaseProblem.findAllPlantPartPhaseProblems(),
                language );
    ...
    public ResponseEntity < PlantPartPhaseProblemResource > getPlantPartPhaseProblemByLanguage( Long id,
            Languages language )
    {
    ...
    @Deprecated
    public ResponseEntity < PlantPartPhaseProblemResourceList > getPlantPartPhaseProblemByPPPSymptomsAndLanguage(
            String pppSymptomsCsv, Languages language )
    {

        System.out.println( "getProblemsBySymptomsAndLanguage - try to get for symptoms:" + pppSymptomsCsv + " lang:"
                + language );
        ResponseEntity < PlantPartPhaseProblemResourceList > response;
        ...
        for ( String plantPartPhaseSymptomIdStr : pppSymptomIdStings )
        {
            ...
            {
                PlantPartPhaseSymptom pppSymptom = PlantPartPhaseSymptom.findPlantPartPhaseSymptom( Long
                        .parseLong( plantPartPhaseSymptomIdStr ) );
                if ( pppSymptom != null )
                {
    ...
    public ResponseEntity < PlantPartPhaseProblemResourceList > getPlantPartPhaseProblemBySymptomsAndLanguage( Long id,
            String symptomsCsv, Languages language )
    {
        System.out.println( "getPlantPartPhaseProblemBySymptomsAndLanguage - try to get for PPPID: " + id
                + " symptoms:" + symptomsCsv + " lang:" + language );
        ResponseEntity < PlantPartPhaseProblemResourceList > response;
            ...
            if ( symptomIdStr != null )
            {
                ...
                if ( s != null )
                {
                    ...
                    List < PlantPartPhaseSymptom > plantPartPhaseSymptoms = PlantPartPhaseSymptom
                            .findPlantPartPhaseSymptomsByPlantPartPhaseAndSymptom( ppp, s ).getResultList();
    ...
    public ResponseEntity < ProductResourceList > getProductsByPlantPhaseProblemAndActiveIngredientAndLanguage(
            Long pppID, Long aID, Languages language )
    {
        System.out.println( "getProductsByPlantPhaseProblemsAndActiveIngredientAndLanguage - try to get for pppId:"
                + pppID + " aID:" + aID + " lang:" + language );
        ...
        TypedQuery < ProblemAIProduct > tq = ProblemAIProduct.findProblemAIProductsByProblemAndActiveIngredient(
                pppProblem, activeIngredient );
    ...
    public ResponseEntity < ProductResourceList > getProductsByPlantPhaseProblemAndLanguage( Long pppID,
            Languages language )
    {
        System.out.println( "getProductsByPlantPhaseProblemAndLanguage - try to get for pppId:" + pppID + " lang:"
                + language );
