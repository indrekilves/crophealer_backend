...
import com.crophealer.rest.v1.PlantPartPhaseResourceAssembler;
...
public class PlantRestService extends GenericRestService
{
    ...
    public ResponseEntity < GrowthPhaseResourceList > getAllGrowthPhasesForPlantByLanguage( Long id, Languages language )
    {
        ...
        // System.out.println("getAllGrowthPhasesForPlant - found (Plant):" +
        // plant.toString());
        ...
        // System.out.println("getAllGrowthPhasesForPlant - found (PlantProblemAreas):"
        // + ppps.toString());
    ...
    public ResponseEntity < PlantPartResourceList > getAllPlantPartsForPlantInGrowthPhaseByLanguage( Long pId,
            Long gpId, Languages language )
    {
        System.out.println( "getAllPlantPartsForPlantInGrowthPhaseByLanguage plantID: " + pId + " growthCode: " + gpId
                + " lang:" + language );
        ...
        System.out.println( "getAllPlantPartsForPlantInGrowthPhaseByLanguage - found (GrowthPhase):"
                + growthPhase.getComment() );

        // Get PlantPartPhase
        List < PlantPartPhase > plantPartPhases = PlantPartPhase.findPlantPartPhasesByPlantAndGrowthPhase( plant,
                growthPhase ).getResultList();
        if ( plantPartPhases == null )
        {
            response = new ResponseEntity <>( HttpStatus.NOT_FOUND );
            return response;
        }
        // System.out.println("getAllPlantPartsForPlantInGrowthPhaseByLanguage - found (PlantPartPhase):"
        // + plantPartPhases.get);
        ...
        // System.out.println("getAllPlantPartsForPlantInGrowthPhaseByLanguage - found (Plant Parts):"
        // + plantParts.toString());
    ...
    @Deprecated
    public ResponseEntity < SymptomResourceList > getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage( Long pId,
            Long gpId, Long ppId, Languages language )
    {
        System.out.println( "getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage plantID: " + pId
                + " growthPhaseId: " + gpId + " plantPart: " + ppId + " Lang: " + language );
        ...
        System.out.println( "getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (Plant):"
                + plant.getComment() );
        ...
        System.out.println( "getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (GrowthPhase):"
                + growthPhase.getComment() );
        ...
        System.out.println( "getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (PlantPart):"
                + plantPart.getComment() );

        // GetPlantPartPhase
        List < PlantPartPhase > plantPartPhases = (List < PlantPartPhase >) PlantPartPhase
                .findPlantPartPhasesByPlantAndGrowthPhaseAndPlantPart( plant, growthPhase, plantPart ).getResultList();
        if ( plantPartPhases == null )
        {
            response = new ResponseEntity <>( HttpStatus.NOT_FOUND );
            return response;
        }
        // System.out.println("getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (plantPartPhases):"
        // + plantPartPhases.toString());
        ...
        // System.out.println("getAllSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (Symptoms):"
        // + symptoms.toString());
    ...
    {
        System.out.println( "getAllPlantPartPhaseSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage plantID: " + pId
                + " growthPhaseId: " + gpId + " plantPart: " + ppId + " Lang: " + language );
        ...
        System.out
                .println( "getAllPlantPartPhaseSymptomsForPlantPartAndGrowthPhaseAndPlantByLanguage - found (PlantPart):"
                        + plantPart.getComment() );
    ...
    public ResponseEntity < PlantPartPhaseResourceList > getPlantPartPhasesForPlantPartAndGrowthPhaseAndPlantByLanguage(
            Long pId, Long gpId, Long ppId, Languages language )
    {
        System.out.println( "getPlantPartPhasesForPlantPartAndGrowthPhaseAndPlantByLanguage plantID: " + pId
                + " growthPhaseId: " + gpId + " plantPart: " + ppId + " Lang: " + language );

        // Get Plant
        ResponseEntity < PlantPartPhaseResourceList > response;
        ...
        PlantPartPhaseResourceAssembler asm = new PlantPartPhaseResourceAssembler();
        PlantPartPhaseResourceList ppprl = asm.toResource( plantPartPhases, language );

        response = new ResponseEntity <>( ppprl, HttpStatus.OK );
        return response;
    }
