...
public class ActiveIngredient {
    ...
    public static TypedQuery<ActiveIngredient> findActiveIngredientsByCommentEqualsCustom(String comment) {
        ...
        TypedQuery<ActiveIngredient> q = em.createQuery("SELECT o FROM ActiveIngredient AS o WHERE LOWER(o.comment) = LOWER(:comment)", ActiveIngredient.class);
    ...
    public static TypedQuery<ActiveIngredient> findActiveIngredientsByLatinNameEqualsCustom(String latinName) {
        ...
        EntityManager em = ActiveIngredient.entityManager();
        TypedQuery<ActiveIngredient> q = em.createQuery("SELECT o FROM ActiveIngredient AS o WHERE LOWER(o.latinName) = LOWER(:latinName)", ActiveIngredient.class);
