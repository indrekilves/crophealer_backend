...
public class Company
{
    ...
    private void fillFromResource( CompanyResource cr )
    {
        ...
        if ( cr.getName() != null )
            this.setName( cr.getName() );
        if ( cr.getAddress() != null )
            this.setAddress( cr.getAddress() );
        if ( cr.getContactPerson() != null )
            this.setContactPerson( cr.getContactPerson() );
        if ( cr.getEmail() != null )
            this.setEmail( cr.getEmail() );
        if ( cr.getPhone() != null )
            this.setPhone( cr.getPhone() );
        if ( cr.getFieldSize() != null )
            this.setFieldSize( cr.getFieldSize() );
    }
}
