...
public class PlantPartPhaseProblem
{
     ...
     *                    private final Set<ProblemActiveIngredient>
    ...
    public Plant getPlant()
    {
        TypedQuery < PlantPartPhaseSymptom > symptomsQ = PlantPartPhaseSymptom
                .findPlantPartPhaseSymptomsByProblem( this );
    ...
    public String toString()
    {
        ...
        return "PlantPartPhaseProblem [comment=" + comment + ", pppSymptoms=" + symptomIdsCSV + ", problem="
                + problemId + ", problemActiveIngredients=" + problemActiveIngredientIdCsv + "]";
    }
    ...
    {
        if ( activeIngredientProductLinks == null )
            return null;
